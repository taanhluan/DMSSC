...
function dashboardRoutes() {
    ...
    r.get("/", async (_req, res) => {
        try {
            ...
            // 4) Recent items
            const recent = await prisma_1.prisma.backlog.findMany({
            ...
            const upcoming = await prisma_1.prisma.backlog.findMany({
                where: {
